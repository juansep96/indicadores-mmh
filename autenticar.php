...
<head>
  ...
  <title>Inicio Automatico - Intranet Indicadores - Municipalidad de Monte Hermoso</title>
  <style>
    .iconError{
...
<body onload="autoLogin();">
          ...
          <div class="authentication-card">
            <div class="card shadow rounded-0 overflow-hidden p-5">
              <div class="row g-0">
                ...
                <img src="./assets/images/logo.png?v=1.1" class="img-fluid" alt="" style="width:250px">
                </div>
              </div>
              <div class="row g-0">
  ...
  <!--app-->
  <script src="./js/index.js?v=0.06"></script>
